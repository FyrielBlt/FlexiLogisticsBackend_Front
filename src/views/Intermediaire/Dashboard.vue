      ...
      <div class="flex flex-wrap -mx-6">
        ...
        <div class="w-full px-6 mt-6 sm:w-1/2 xl:w-1/3 xl:mt-0">
          ...
          >
            ...
            <div class="mx-5">
              <h4 class="text-2xl font-semibold text-gray-700">1</h4>
              <div class="text-gray-500">transporteur</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="flex flex-wrap -mx-6">
        <div class="w-full px-6 sm:w-1/2 xl:w-1/3">
          ...
          >
            ...
            <div class="mx-5">
              <h4 class="text-2xl font-semibold text-gray-700">1</h4>
              <div class="text-gray-500">nombre damande</div>
            </div>
          </div>
        </div>
        ...
        <div class="w-full px-6 mt-6 sm:w-1/2 xl:w-1/3 sm:mt-0">
          ...
          >
            ...
            <div class="mx-5">
              <h4 class="text-2xl font-semibold text-gray-700">1</h4>
              <div class="text-gray-500">nombre facture transporteur</div>
            </div>
          </div>
        </div>
        ...
        <div class="w-full px-6 mt-6 sm:w-1/2 xl:w-1/3 xl:mt-0">
          ...
          >
            ...
            <div class="mx-5">
              ...
              <div class="text-gray-500">nombre facture client </div>
            </div>
          </div>
        </div>
      </div>
...
export default {
  ...
  computed: {
    ...mapGetters(["ListePersonnellesAll"]),
  },
  mounted() {
