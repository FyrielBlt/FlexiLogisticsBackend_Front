      ...
      <template v-slot:menu>
        ...
        <router-link class="flex items-center px-6 py-2 mt-4 duration-200 border-l-4"
          ...
          <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
            ...
            xml:space="preserve">
            <g>
              <path fill="currentColor" d="M306,317.657c46.677,0,84.514-37.838,84.514-84.514S352.677,148.629,306,148.629c-46.676,0-84.514,37.838-84.514,84.514
        ...
        <router-link class="flex items-center px-6 py-2 mt-4 duration-200 border-l-4"
          ...
          <svg width="24px" height="24px" viewBox="0 -12 158 158" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <defs>
              <clipPath id="clip0">
                <rect width="157" height="134" fill="currentColor" transform="translate(0.777344)" />
              </clipPath>
            </defs>
          </svg>
        ...
        <router-link class="flex items-center px-6 py-2 mt-4 duration-200 border-l-4"
          ...
          <svg width="24px" height="24px" viewBox="0 0 36 36" version="1.1" preserveAspectRatio="xMidYMid meet"
            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            <title>notification-line</title>
            <path fill="currentColor" class="clr-i-outline clr-i-outline-path-1"
            ...
            <path fill="currentColor" class="clr-i-outline clr-i-outline-path-2"
